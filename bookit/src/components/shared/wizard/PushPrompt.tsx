    ...
    <AnimatePresence mode="popLayout">
      {state === 'subscribed' ? (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className="w-full flex items-center gap-2.5 px-4 py-3 rounded-xl bg-success/10 border border-success/25"
        >
        ...
        <motion.div
          ...
          exit={{ opacity: 0, y: -4 }}
          className="w-full flex items-start gap-3 px-4 py-3 rounded-xl bg-primary/8 border border-primary/20"
        >
