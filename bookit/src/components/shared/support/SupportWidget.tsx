  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-[92px] right-4 lg:bottom-6 lg:right-6 z-[99] flex h-12 w-12 items-center justify-center rounded-full bg-[var(--surface)] border border-[var(--border-strong)] backdrop-blur-xl text-[var(--text-primary)] shadow-md hover:shadow-lg transition-all duration-200 cursor-pointer relative overflow-hidden group active:scale-[0.95]"
      >
        ...
        <div className="relative flex items-center justify-center">
          <MessageCircle className="h-6 w-6 relative z-10 text-[var(--accent)] group-hover:rotate-6 transition-transform duration-200" />
          {/* Status green dot */}
        ...
        <div className="text-slate-900 flex flex-col h-full max-h-[70vh]">
          ...
          {step === 'selection' && (
            <div className="grid grid-cols-1 gap-3.5 sm:grid-cols-2">
              ...
              >
                ...
                <span className="absolute -top-10 -right-10 w-24 h-24 bg-indigo-400/10 rounded-full blur-xl animate-pulse" />
                <div className="flex gap-4 relative z-10">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-indigo-100 text-indigo-600 shadow-inner">
                ...
                <ChevronRight className="h-5 w-5 text-indigo-500 relative z-10 group-hover:translate-x-0.5 transition-transform" />
              </button>
              ...
              >
                <div className="flex gap-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-slate-50 text-slate-600">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl bg-white border border-slate-100 p-3">
                ...
                {filePreview && (
                  <div className="relative flex items-center gap-2 rounded-xl bg-slate-50 border border-slate-200 p-1.5 pr-8">
                    <img src={filePreview} alt="Preview" className="h-7 w-7 rounded object-cover" />
                    ...
                    <button
                      type="button"
                      onClick={removeFile}
                      className="absolute right-1 w-5 h-5 flex items-center justify-center rounded-full bg-slate-200 text-slate-600 hover:bg-slate-300 hover:text-slate-800 active:scale-[0.90] cursor-pointer"
                    >
                      <X className="h-3 w-3" />
                    </button>
                  </div>
          ...
          {step === 'success' && (
            <div className="flex flex-col items-center justify-center py-12 text-center shrink-0">
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-green-50 text-green-600 mb-4 animate-bounce">
