...
const features = [
  ...
  },
  {
    ...
    description:
      'Створюйте професійні Stories з вільними вікнами в один клік. Автоматична генерація залучає клієнтів з Instagram без витрат часу на дизайн.',
    iconCls: 'bg-destructive/10 text-destructive',
  },
  {
    icon: ShoppingBag,
    ...
    description:
      'Продавайте товари прямо під час запису клієнта. Екосистема бере на себе контроль залишків, cross-sell рекомендації та інтеграцію доставки Новою Поштою.',
