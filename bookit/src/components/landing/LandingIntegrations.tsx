...
const NOTIFICATIONS = [
  {
    ...
    time: '09:47',
    icon: (
      <Image src="/landing/telegram.png" width={36} height={36} alt="Telegram" />
    ),
  },
  {
    channel: 'Push',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <motion.div style={{ y: headingY }}>
            ...
            <motion.p
              ...
              transition={{ ...LANDING_SPRING, delay: 0.28 }}
            ...
            <div className="mt-10 flex flex-col gap-0" style={{ borderTop: '1px solid var(--l-border)' }}>
              {CHANNELS.map((ch, i) => (
                <motion.div
                  ...
                  animate={inView ? { opacity: 1, y: 0 } : {}}
                  transition={{ duration: shouldReduce ? 0 : 0.65, ease: easeOut, delay: shouldReduce ? 0 : 0.36 + i * 0.08 }}
            ...
            {NOTIFICATIONS.map((n, i) => (
              <motion.div
                ...
                transition={
                  shouldReduce
                    ? { duration: 0 }
                    : { type: 'spring', stiffness: 200, damping: 18, delay: 0.1 + i * 0.35 }
                }
