    ...
    <div className="min-h-screen bg-transparent">
      <div className="max-w-2xl mx-auto px-4 pt-10 pb-24">
        ...
        >
          ...
          >
            <span className={!activeCategory ? 'text-accent' : 'text-muted-foreground'}>
              <Sparkles size={20} />
            </span>
            <span className={`text-[10px] font-medium leading-tight text-center ${!activeCategory ? 'text-accent' : 'text-muted-foreground/80'}`}>
              Всі
            </span>
          ...
          {serviceCategories.map(cat => {
            ...
            return (
              ...
              >
                ...
                <span className={`text-[10px] font-medium leading-tight text-center ${active ? 'text-accent' : 'text-muted-foreground/80'}`}>
                  {cat.label}
                </span>
      ...
      <Link href={`/${master.slug}`} className="block">
        <div className="bento-card overflow-hidden active:scale-[0.97] transition-transform duration-150">
          ...
          <div className="relative h-44">
            ...
            {/* PRO badge — top-left */}
            {master.isPro && (
              <span className="absolute top-2.5 left-2.5 text-[9px] font-bold text-white bg-warning px-1.5 py-0.5 rounded-full leading-none">
                PRO
              </span>
            )}
          ...
          <div className="p-3">
            ...
            {master.ratingCount > 0 && (
              <div className="flex items-center gap-1 mt-2">
                ...
                <span className="text-[10px] text-muted-foreground/50">· {master.ratingCount} відг.</span>
              </div>
            )}
            ...
            <div className="flex items-center justify-between mt-1.5 gap-1">
              <div className="flex items-center gap-1 min-w-0 overflow-hidden">
                ...
                {master.serviceCount > 0 && (
                  <>
                    {master.city && <span className="text-[10px] text-muted-foreground/40 flex-shrink-0">·</span>}
