      ...
      <div className="flex p-1 bg-secondary rounded-2xl">
        <button
          ...
          className={cn(
            ...
            activeTab === 'loyalty' ? "bg-white text-foreground shadow-sm" : "text-muted-foreground/60"
          )}
        >
          <Gift size={14} />
          Лояльність
        ...
        <button
          ...
          className={cn(
            "flex-1 flex items-center justify-center gap-2 py-2.5 text-xs font-bold rounded-xl transition-all",
            activeTab === 'referral' ? "bg-white text-foreground shadow-sm" : "text-muted-foreground/60"
          )}
        >
          <Users size={14} />
          Refer & Earn
          ...
          >
            ...
            {programs.length === 0 ? (
              <div className="bento-card p-10 text-center flex flex-col items-center gap-3">
                ...
                <Link
                  href="/my/masters"
                  className="mt-1 inline-flex items-center gap-1.5 px-5 py-2.5 rounded-2xl bg-primary text-white text-xs font-bold hover:bg-primary/90 transition-colors shadow-lg shadow-[#789A99]/20"
                >
                  Знайти майстрів
                </Link>
              </div>
            ...
            <div className="flex p-1 bg-secondary rounded-2xl">
              <button
                ...
                className={cn(
                  ...
                  referralSubTab === 'c2c' ? "bg-white text-foreground shadow-sm" : "text-muted-foreground/60"
                )}
              >
              ...
              <button
                ...
                className={cn(
                  "flex-1 flex items-center justify-center gap-1.5 py-2 text-[11px] font-bold rounded-xl transition-all",
                  referralSubTab === 'c2b' ? "bg-white text-foreground shadow-sm" : "text-muted-foreground/60"
                )}
              >
                      ...
                      >
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl bg-primary text-white text-xs font-semibold hover:bg-[#6B8C8B] transition-colors"
                          >
                            <Share2 size={12} /> Поділитись
                          </button>
                          <button
                            onClick={() => copyToClipboard(m.shareLink, m.masterId)}
                            className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl bg-white/80 border border-white/80 text-xs font-medium text-muted-foreground hover:bg-white transition-colors"
                          >
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-2 mb-3">
        ...
        <Link
          href={`/${p.masterSlug}`}
          className="flex-shrink-0 text-[11px] font-semibold text-primary hover:text-primary/90 transition-colors px-2.5 py-1 rounded-xl bg-primary/10 hover:bg-primary/20"
        >
          Записатись
        </Link>
      </div>
