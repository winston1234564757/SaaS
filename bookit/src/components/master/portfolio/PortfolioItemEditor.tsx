    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full md:max-w-xl max-h-[92dvh] overflow-y-auto rounded-t-[28px] md:rounded-[28px] bg-background/95 backdrop-blur-xl border border-border/40"
        >
          {/* ── Header ── */}
          <div
            className="sticky top-0 z-10 flex items-center justify-between px-5 py-4 border-b border-border bg-background/95 backdrop-blur-md"
          >
            ...
            <div className="flex items-center gap-2">
              {itemId && (
                <button type="button"
                  ...
                  className={cn(
                    "flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-medium border transition-colors disabled:opacity-60 active:scale-[0.95] cursor-pointer transition-all",
                    isPublished
              ...
              <button type="button"
                ...
                aria-label="Закрити"
                className="size-8 rounded-xl bg-secondary flex items-center justify-center text-text-sub active:scale-[0.88] cursor-pointer transition-all"
              >
            ...
            <div className="p-5 space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-border bg-secondary/40 px-4 py-3 text-sm text-foreground placeholder:text-text-sub focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/20"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border border-border bg-secondary/40 px-4 py-3 text-sm text-foreground placeholder:text-text-sub focus:outline-none focus:border-primary resize-none"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full rounded-xl border border-border bg-secondary/40 px-4 py-3 text-sm text-foreground focus:outline-none focus:border-primary appearance-none"
                  >
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      <select
                        ...
                        className="w-full rounded-xl border border-border bg-secondary/40 px-4 py-2.5 text-sm text-foreground focus:outline-none focus:border-primary appearance-none"
                      >
                        <option value="">
                ...
                <>
                  ...
                  <div className="space-y-3">
                      ...
                      {reviews.map(r => {
                        ...
                        return (
                          <button
                            ...
                            className={cn(
                              "w-full flex items-start gap-3 rounded-2xl p-3 text-left transition-all border active:scale-[0.95] cursor-pointer",
                              isSelected
                    ...
                    <button
                      ...
                      className="w-full rounded-xl py-2.5 text-xs font-semibold border border-primary text-primary hover:bg-primary/10 transition-colors disabled:opacity-50 active:scale-[0.95] cursor-pointer transition-all"
                    >
                      {reviewsPending
              ...
              <div className="flex gap-2 pt-1">
                {itemId && (
                  <button
                    ...
                    className="flex items-center gap-1.5 px-4 py-2.5 rounded-xl text-xs font-semibold text-destructive border border-destructive/30 hover:bg-destructive/10 transition-colors active:scale-[0.95] cursor-pointer transition-all"
                  >
                    {deletePending
