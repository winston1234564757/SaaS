      ...
      {preview ? (
        <div className="relative w-full aspect-square shrink-0 rounded-xl overflow-hidden border border-border bg-muted object-center">
          ...
          <button
            type="button"
            onClick={handleClear}
            className="absolute top-2 right-2 bg-foreground/60 text-background rounded-full w-6 h-6 flex items-center justify-center text-xs hover:bg-foreground/80 active:scale-95 transition-all"
          >
            <X size={10} />
          </button>
        </div>
