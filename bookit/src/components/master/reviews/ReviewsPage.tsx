  ...
  return (
    <div className="flex flex-col gap-4 pb-8">
      <div className="flex flex-col gap-4 lg:grid lg:grid-cols-[260px_1fr] lg:gap-6 lg:items-start">
        ...
        {/* Left sidebar: header + stats + filters */}
            ...
            <div className="flex flex-wrap gap-2">
              {filterPills.map(pill => (
                <button
                  ...
                  className={cn(
                    'flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold transition-all active:scale-[0.88] cursor-pointer',
                    filter === pill.key
                      ? 'bg-[var(--btn-primary-bg)] text-[var(--accent-on)] shadow-sm'
                      : 'bg-secondary/40 border border-border text-muted-foreground hover:bg-secondary/80'
                  )}
                >
                  {pill.label}
                  <span className={cn(
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <button
                        ...
                        className={cn(
                          'flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl text-[11px] font-semibold transition-all active:scale-[0.88] disabled:opacity-50 cursor-pointer',
                          r.is_published
