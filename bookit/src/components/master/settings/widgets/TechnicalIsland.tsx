...
const THEMES: { key: MoodThemeKey; label: string; color: string }[] = [
  { key: 'default', label: 'Blossom', color: '#FFF2DF' },
    ...
    <div className="widget-card p-5 space-y-8">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 gap-3">
          <div className="flex items-center gap-3 p-3 rounded-2xl bg-white/40 border border-white/60 focus-within:border-accent/40 transition-all">
        ...
        <div className={cn(
          ...
          {!telegramChatId && (
            <button
              ...
              className="w-full py-3 rounded-xl bg-accent text-white text-xs font-bold flex items-center justify-center gap-2 active:scale-95 transition-all shadow-md shadow-accent/10"
            >
          ...
          {THEMES.map((theme) => (
            <button
              ...
              className={cn(
                ...
                themeKey === theme.key ? "bg-white border-accent shadow-sm" : "bg-white/40 border-white/60 grayscale opacity-60 hover:grayscale-0 hover:opacity-100"
              )}
            >
              <div 
      ...
      <div className="pt-4 border-t border-white/40">
        <a 
          ...
          className="flex items-center justify-between p-4 rounded-2xl bg-white/40 border border-white/60 hover:bg-white transition-all group"
        >
