  ...
  return (
    <div className="widget-card p-6 h-full flex flex-col gap-6">
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-2 px-4 py-3.5 rounded-2xl bg-white border border-white/60 focus-within:border-accent focus-within:ring-4 focus-within:ring-accent/5 transition-all shadow-inner-sm">
      ...
      <div className="flex flex-col gap-3 mt-auto">
        <a 
          href={publicUrl} 
          target="_blank" 
          className="w-full py-4 rounded-2xl bg-white border border-white/80 text-text-primary text-xs font-bold flex items-center justify-center gap-2 hover:bg-muted/10 active:scale-95 transition-all shadow-sm"
        >
        ...
        {!showQr ? (
          ...
          <motion.div
            ...
            className="flex flex-col items-center gap-4 bg-white/40 p-4 rounded-3xl border border-white/60"
          >
            <div className="p-4 rounded-[24px] bg-white shadow-xl border border-white/80">
              <img 
                ref={qrRef}
                src={qrUrl} 
                alt="QR Code" 
            ...
            <div className="flex w-full gap-2">
              ...
              <button
                ...
                className="px-4 py-3 rounded-xl bg-white/80 text-text-mute text-[11px] font-bold border border-white/60 active:scale-95 transition-all"
              >
                Сховати
              </button>
            </div>
