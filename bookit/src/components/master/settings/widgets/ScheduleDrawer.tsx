                ...
                {DAYS_ORDER.map((day) => (
                  <div 
                    ...
                    className={cn(
                      ...
                      schedule[day].is_working ? "bg-white border-white/60 shadow-sm" : "bg-muted/10 border-transparent opacity-60"
                    )}
                  >
                    <button
                    ...
                    {schedule[day].is_working ? (
                      <div className="flex items-center gap-2 flex-1">
                        <input
                          ...
                          className="flex-1 px-3 py-2 rounded-xl bg-muted/30 border border-transparent focus:bg-white focus:border-accent/40 outline-none text-sm font-medium"
                        />
              ...
              <div className="pb-10">
                ...
                <div className="space-y-3">
                  {breaks.length === 0 ? (
                    ...
                    breaks.map((b, i) => (
                      <div key={i} className="flex items-center gap-3 p-4 rounded-2xl bg-white border border-white/60">
                        <input
                          type="time"
                          value={b.start}
                          onChange={(e) => {
