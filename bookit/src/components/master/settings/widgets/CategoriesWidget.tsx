    ...
    <div className="widget-card p-6 h-full flex flex-col">
        ...
        {ALL_CATEGORIES.map((cat) => {
          ...
          return (
            <button
              ...
              disabled={isDisabled}
              className={cn(
                'min-h-[44px] px-5 py-2.5 rounded-2xl text-[11px] font-bold transition-all flex items-center gap-2 border',
                isSelected
      ...
      <div className="mt-auto pt-5">
        ...
        <div
          ...
          className="w-full h-1 bg-muted/40 rounded-full mt-2 overflow-hidden"
        >
          <motion.div
