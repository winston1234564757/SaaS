...
function ConditionRow({
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="p-4 rounded-2xl bg-white border border-white/80 flex flex-col gap-3 shadow-sm">
        ...
        <div className="flex items-center gap-2">
          <div className="relative flex-1 min-w-0">
            <select
              ...
              className="w-full appearance-none px-3 py-2.5 pr-8 rounded-xl bg-muted/15 border border-transparent text-sm font-bold text-foreground outline-none focus:bg-white focus:border-accent/30 cursor-pointer truncate"
            >
          ...
          <button
            type="button"
            onClick={onRemove}
            className="w-9 h-9 rounded-xl bg-error/5 text-error flex items-center justify-center hover:bg-error/10 active:scale-95 transition-all shrink-0"
          >
            <Trash2 size={14} />
          </button>
        </div>
        ...
        {isNumeric && (
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="w-24 shrink-0 px-3 py-2 rounded-xl bg-muted/15 border border-transparent text-sm font-bold text-right outline-none focus:bg-white focus:border-accent/30"
            />
          </div>
        )}
      ...
      {index < total - 1 && (
        <div className="flex items-center gap-3 px-2 my-0.5">
          ...
          <button
            ...
            className="px-3.5 py-1.5 rounded-xl bg-accent/10 text-accent text-[10px] font-black uppercase tracking-widest hover:bg-accent/20 active:scale-95 transition-all"
          >
        ...
        {step === 'template' && (
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-2.5">
              {TEMPLATES.map(t => (
                <motion.button
                  ...
                  className="flex flex-col gap-2 p-3.5 rounded-2xl border border-white/80 bg-white/60 hover:bg-white text-left transition-all active:scale-[0.97]"
                >
                  <div
            ...
            <button
              ...
              className="w-full py-3.5 rounded-2xl border border-dashed border-accent/30 text-accent text-sm font-bold hover:bg-accent/5 transition-colors"
            >
              + Створити з нуля
            </button>
          </motion.div>
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 shadow-sm transition-all active:scale-95"
              ...
              <input
                ...
                className="flex-1 px-4 py-3 rounded-2xl bg-white border border-white/80 focus:border-accent/40 focus:ring-2 focus:ring-accent/10 outline-none text-sm font-bold"
                          ...
                          <button
                            ...
                            className={cn(
                              ...
                              icon === ic
                                ...
                                : 'bg-white border border-white/80 text-muted-foreground/50 hover:text-foreground'
                            )}
                          >
                      ...
                      <div className="flex gap-2">
                        {SEGMENT_PRESET_COLORS.map(c => (
                          <button
                            key={c} type="button"
                            onClick={() => setColor(c)}
                            className={cn('w-8 h-8 rounded-xl transition-all', color === c ? 'ring-2 ring-offset-2 ring-foreground/30 scale-110' : 'hover:scale-105')}
                            style={{ background: c }}
                          />
                        ))}
                      </div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 rounded-2xl border border-dashed border-accent/25 text-accent text-xs font-bold hover:bg-accent/5 transition-colors mt-1"
                >
            ...
            <div className="flex gap-3">
              {!initial && (
                <button
                  ...
                  className="px-4 py-3.5 rounded-2xl bg-muted/20 text-muted-foreground text-sm font-bold hover:bg-muted/30 transition-colors"
                >
                  Шаблони
                </button>
              )}
              {initial && onDelete && (
                <button
                  ...
                  className="px-4 py-3.5 rounded-2xl bg-error/5 text-error text-sm font-bold hover:bg-error/10 transition-colors"
                >
                  Видалити
                </button>
              )}
              <button
                ...
                onClick={handleSave}
                disabled={!isValid}
                className="flex-1 py-3.5 rounded-2xl bg-accent text-white text-sm font-bold disabled:opacity-40 hover:opacity-90 active:scale-[0.99] transition-all"
              >
                {matchCount > 0
