...
function BentoWidget({ id, span = "col-span-1 row-span-1" }: BentoWidgetProps) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "group relative bg-secondary/60 backdrop-blur-md border border-border rounded-xl shadow-sm hover:shadow-xl transition-all overflow-hidden cursor-default",
        span,
          ...
          <button type="button"
            ...
            className={cn(
              ...
              isCustomizing 
                ...
                : "bg-secondary/40 text-primary border border-border hover:bg-secondary/80"
            )}
          >
            {isCustomizing ? (
        ...
        <AnimatePresence mode="popLayout">
          ...
          {isCustomizing && (
            <motion.button
              ...
              className="md:col-span-1 md:row-span-1 rounded-xl border-4 border-dashed border-primary/20 hover:border-primary/40 hover:bg-primary/5 transition-all flex flex-col items-center justify-center gap-2 text-primary/40 hover:text-primary"
            >
              <Plus size={32} />
