      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-lg bg-secondary/90 backdrop-blur-2xl rounded-3xl shadow-2xl border border-border p-8 z-[70]"
          >
              ...
              {available.length > 0 ? (
                available.map((id) => {
                  ...
                  return (
                    ...
                    >
                      <div className="w-12 h-12 rounded-xl bg-peach/40 flex items-center justify-center group-hover:scale-110 transition-transform">
