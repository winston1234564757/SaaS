...
export function SharePageCard() {
  ...
  return (
    <div className="bento-card p-4" data-tour-step="act-1">
      ...
      <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-secondary/60 border border-border mb-3">
            ...
            >
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 20px 60px color-mix(in srgb, var(--text-primary) 18%, transparent)',
              ...
              >
                ...
                <a
                  ...
                  className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg bg-primary/10 text-primary text-xs font-semibold hover:bg-primary/20 transition-all"
                >
                  <Download size={13} />
                  Завантажити PNG
                </a>
