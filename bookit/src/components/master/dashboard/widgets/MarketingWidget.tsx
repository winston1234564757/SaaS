    ...
    <div className="p-6 h-full flex flex-col bg-gradient-to-br from-sage/5 to-primary/5">
      ...
      <div className="mt-4">
        <Link 
          ...
          className="group flex items-center justify-between bg-primary text-white p-3 rounded-lg shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all"
        >
