  ...
  return (
    <div className="p-6 h-full flex flex-col">
      <div className="flex justify-between items-start mb-6">
        <div>
          <h3 className="text-sm font-semibold text-text-sub uppercase tracking-wider">Виручка сьогодні</h3>
      ...
      <div className="flex-1 flex flex-col justify-end gap-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] text-text-sub uppercase font-bold tracking-widest">vs вчора</span>
        </div>

        <div className="bg-secondary/40 border border-border rounded-xl p-3 flex items-center justify-between">
          <div className="flex flex-col">
            <span className="text-[10px] text-text-sub uppercase font-bold tracking-widest">Завершено</span>
