  ...
  const stats = [
    {
      ...
      icon: CalendarDays,
      color: 'var(--sage)',
      bg: 'color-mix(in srgb, var(--sage) 12%, transparent)',
      tooltip: (
    ...
    {showDpTrial && (
      ...
      >
        <Link href="/dashboard/pricing" className="block px-4 py-3 rounded-xl bg-warning/8 border border-warning/20 hover:bg-warning/12 transition-colors">
          ...
          <div className="h-1.5 rounded-full overflow-hidden" style={{ background: 'color-mix(in srgb, var(--accent) 15%, transparent)' }}>
            <div
