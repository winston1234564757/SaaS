...
import {
  ...
  Crown, Zap, Lock, AlertCircle, Clock, Landmark, Sparkles,
} from 'lucide-react';
      ...
      >
        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center rounded-2xl border border-border bg-secondary/60 overflow-hidden shadow-inner">
              <p className="flex-1 px-4 py-3 text-xs text-foreground truncate font-mono min-w-0">
        ...
        {tab === 'overview' ? (
            ...
            <div className="bento-card p-5">
              ...
              {atHardCap ? (
                ...
                <>
                  ...
                  <div className="h-2.5 bg-secondary/50 rounded-full overflow-hidden mb-3">
                    <motion.div
                      initial={{ width: 0 }}
                    ...
                    <div className="mb-3">
                      ...
                      <div className="h-1.5 bg-secondary/50 rounded-full overflow-hidden">
                        <motion.div
                          ...
                          className="h-full bg-gradient-to-r from-primary to-success/80 rounded-full"
                        />
                      </div>
                    </div>
                  )}
          ...
          >
            {history.length === 0 ? (
              ...
              history.map((item) => (
                <div
                  key={item.refereeName + item.joinedAt}
