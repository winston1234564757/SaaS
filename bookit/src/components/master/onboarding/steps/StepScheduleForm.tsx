  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full flex items-center justify-between px-4 py-2.5 rounded-xl bg-primary/10 border border-primary/20 mb-4 hover:bg-primary/15 transition-colors active:scale-95 transition-all"
      >
      ...
      <button
        ...
        onClick={onSave}
        disabled={saving}
        className="w-full py-3.5 rounded-lg bg-primary text-white font-semibold text-sm flex items-center justify-center gap-2 hover:bg-primary/90 transition-colors disabled:opacity-70 active:scale-95 transition-all"
      >
        {saving
