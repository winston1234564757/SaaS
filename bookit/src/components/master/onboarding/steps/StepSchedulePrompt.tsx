    ...
    >
      ...
      <div className="flex flex-col gap-2.5">
        <button
          ...
          className="w-full py-3.5 rounded-lg bg-primary text-white font-semibold text-sm flex items-center justify-center gap-2 hover:bg-primary/90 transition-colors active:scale-95 transition-all"
        >
        ...
        <button
          type="button"
          onClick={onSkip}
          className="w-full py-3 rounded-lg bg-secondary/70 border border-border text-sm font-medium text-muted-foreground hover:bg-secondary transition-colors active:scale-95 transition-all"
        >
          Пропустити
        </button>
      </div>
