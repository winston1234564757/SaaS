    ...
    >
      ...
      <div className="flex flex-col gap-3 mb-7">
        ...
        <div
          ...
          style={{
            background: tgState === 'opened' ? 'rgba(120,154,153,0.08)' : 'rgba(255,255,255,0.8)',
            border: tgState === 'opened' ? '1.5px solid rgba(120,154,153,0.35)' : '1px solid rgba(232,208,200,0.9)',
            boxShadow: '0 2px 12px rgba(44,26,20,0.06)',
          }}
        >
          <div
            className="w-11 h-11 rounded-xl shrink-0 flex items-center justify-center text-xl"
            style={{ background: tgState === 'opened' ? 'rgba(120,154,153,0.15)' : '#229ED9' }}
          >
            {tgState === 'opened' ? '✓' : '✈️'}
          </div>
          ...
          {botName && (
            <button
              ...
              style={{
                background: tgState === 'opened' ? 'rgba(120,154,153,0.15)' : '#229ED9',
                color: tgState === 'opened' ? '#789A99' : '#fff',
              }}
            >
        ...
        <div
          className="rounded-2xl p-4 flex items-center gap-3 transition-all"
          style={{
            background: pushState === 'done' ? 'rgba(120,154,153,0.08)' : 'rgba(255,255,255,0.8)',
            border: pushState === 'done' ? '1.5px solid rgba(120,154,153,0.35)' : '1px solid rgba(232,208,200,0.9)',
            boxShadow: '0 2px 12px rgba(44,26,20,0.06)',
          }}
        >
        ...
        <div
          ...
          style={{ background: 'rgba(120,154,153,0.06)', border: '1px solid rgba(120,154,153,0.15)' }}
        >
      ...
      <button
        ...
        onClick={onComplete}
        disabled={saving}
        className="flex items-center justify-center gap-2 w-full py-4 rounded-2xl bg-primary text-white text-sm font-semibold hover:bg-[#6a8988] active:scale-[0.98] transition-all shadow-lg shadow-[#789A99]/25 disabled:opacity-60"
      >
