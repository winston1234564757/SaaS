...
function TemplateCard({
  ...
  return (
    <motion.div
      ...
      className="rounded-xl overflow-hidden bg-secondary/70 border border-border"
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 pt-3 pb-2">
        <div className="flex items-center gap-2">
          ...
          <span
            className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-sage/12 text-sage"
          >
            {badge}
          </span>
        </div>
      ...
      <div className="relative z-10">
        ...
        <div className="px-6 pb-7 flex flex-col gap-2.5">
          ...
          <motion.button
            ...
            className="w-full py-4 rounded-lg font-semibold text-sm flex items-center justify-center gap-2 transition-all duration-200 disabled:opacity-50 cursor-pointer"
            style={{
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.96 }}>
            <Link
              ...
              onClick={onComplete}
              className="w-full py-3.5 rounded-lg font-semibold text-sm flex items-center justify-center gap-2 transition-all duration-200 cursor-pointer"
              style={{
                background: 'color-mix(in srgb, var(--color-sage) 12%, transparent)',
                color: 'var(--color-sage)',
                border: '1.5px solid color-mix(in srgb, var(--color-sage) 25%, transparent)',
              }}
            >
