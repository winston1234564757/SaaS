    ...
    >
            ...
            {groupCats.map(cat => {
              ...
              return (
                <motion.button
                  ...
                  whileTap={{ scale: 0.96 }}
                  className="relative flex flex-col items-center justify-center gap-2 py-3.5 rounded-xl transition-colors duration-200 cursor-pointer text-center"
                  style={isSelected
                    ? {
                        background: tints.bg,
                    ...
                    {(['express', 'standard', 'premium'] as const).map(type => {
                      ...
                      return (
                        <button
                          ...
                          className="flex items-center gap-0 rounded-xl overflow-hidden transition-all duration-200 cursor-pointer text-left"
                          style={{
                            background: 'var(--surface)',
      ...
      <div className="flex flex-col gap-2 px-6 pb-6">
        <button
          ...
          className="w-full py-4 rounded-lg bg-primary text-primary-foreground font-semibold text-sm flex items-center justify-center gap-2 transition-all duration-200 disabled:opacity-40 cursor-pointer active:scale-95 shadow-lg shadow-sage/35"
        >
          {saving
