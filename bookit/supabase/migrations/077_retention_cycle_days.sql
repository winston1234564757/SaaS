-- Migration 077: dynamic retention cycle per master
-- Adds retention_cycle_days to master_profiles (default 30).
-- Updates get_master_clients RPC to compute retention_status using master's own cycle.

ALTER TABLE master_profiles
  ADD COLUMN IF NOT EXISTS retention_cycle_days INT NOT NULL DEFAULT 30;
