...
import { MapPin, Star, BadgeCheck, Share2, Send, Clock, Zap, Link } from 'lucide-react';
      ...
      <div className="max-w-lg mx-auto px-4 pb-32 pt-6">
        ...
        >
          <div className="flex items-start gap-4">
            ...
            >
              {master.avatarUrl ? (
                <img src={master.avatarUrl} alt={master.name} className="w-full h-full object-cover" />
              ) : (
