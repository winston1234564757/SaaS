...
export function ExplorePageView({ masters, cities }: Props) {
      ...
      <div className="max-w-lg mx-auto px-4 pt-10 pb-20">
        ...
        <div className="mt-10 text-center">
          <p className="text-xs text-[#A8928D]">
            Ти майстер?{' '}
            <Link to="/register" className="text-[#789A99] font-semibold hover:underline">
...
function MasterCard({ master, index }: { master: Master; index: number }) {
  ...
  return (
    ...
    >
      <Link to={`/${master.slug}`} className="block">
