...
export function FloatingSidebar() {
  ...
  return (
    <div className="floating-sidebar flex flex-col p-3">
      {/* Logo */}
      <Link to="/" className="px-4 py-4 mb-2">
      ...
      <div className="pt-3 border-t border-[#E8D5CF]/70">
        <Tooltip content={
          ...
          <Link to="/dashboard/settings" className="flex items-center gap-3 px-3 py-2 rounded-2xl hover:bg-white/55 transition-colors w-full">
            <div
