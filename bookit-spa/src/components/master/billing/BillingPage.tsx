...
export function BillingPage() {
  ...
  function handleUpgrade(tier: Tier) {
    ...
    startTransition(async () => {
      // TODO: implement billing actions via Supabase Edge Functions
      setError('Оплата наразі недоступна в SPA. Використовуйте Edge Functions.');
      setPayingTier(null);
    });
  }
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <Link
              ...
              className="mt-2 inline-block text-xs font-semibold text-[#789A99] hover:text-[#5C7E7D] transition-colors"
            >
