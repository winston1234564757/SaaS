...
import { Check, Loader2, ExternalLink, Link2, Send, Lock, MessageSquare, CreditCard, ChevronRight, LogOut, Plus, Trash2 } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col gap-4 pb-10">
      ...
      <Section title="Соціальні мережі">
        <div className="flex flex-col gap-3">
          ...
          <div>
            ...
            {telegramBotName && masterProfile?.slug ? (
              <div className="flex flex-col gap-2">
                {telegramChatId ? (
                  ...
                  <a
                    href={`https://t.me/${telegramBotName}?start=${masterProfile.slug}`}
                    target="_blank"
      ...
      <div className="bento-card p-4 lg:hidden">
        ...
        {[
          { to: '/dashboard/reviews', icon: MessageSquare, label: 'Відгуки клієнтів' },
          { to: '/dashboard/billing', icon: CreditCard,    label: 'Тариф та оплата'  },
