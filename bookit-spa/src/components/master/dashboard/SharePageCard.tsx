      ...
      <div className="flex gap-2">
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl text-xs font-semibold transition-all ${
            copied ? 'bg-[#5C9E7A]/15 text-[#5C9E7A]' : 'bg-[#789A99]/10 text-[#789A99] hover:bg-[#789A99]/20'
          }`}
        >
          ...
          <>
            ...
            >
              <div
                ...
                style={{ background: 'rgba(255,248,244,0.97)', backdropFilter: 'blur(24px)', boxShadow: '0 20px 60px rgba(44,26,20,0.18)', border: '1px solid rgba(255,255,255,0.7)' }}
              >
                ...
                >
                  <Download size={13} /> Завантажити PNG
                </a>
              </div>
            </motion.div>
          </>
