...
---
### 💬 ПРАВИЛА КОМУНІКАЦІЇ ТА МІРКУВАННЯ
- **Мова міркування:** Завжди проводь детальний процес міркування (`<thought>` блок) **українською мовою**.
- **Мова відповідей:** Відповідай мовою користувача, але внутрішнє міркування має бути деталізованим та українською.
- **Глобальність:** Це правило поширюється на всі чати та моделі.