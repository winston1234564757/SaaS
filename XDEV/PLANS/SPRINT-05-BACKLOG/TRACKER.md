...
**Прогрес:** 34/78 ✅ · 1 ↩️ скасовано (M-DASH-11) | **Розпочато:** 2026-06-21 | **Оновлено:** 2026-06-27
**▶ NEXT:** `M-SHOP-03b` — Магазин: система відгуків про товари (БД + flow збору + показ) (create-migration + security-review + senior-backend · Opus · P1)
...
| `M-SHOP-03b` | Магазин: система відгуків про товари (нова таблиця `product_reviews` + RPC `get_product_reviews` + `submitProductReview` flow на завершеному замовленні + показ на сторінці товару) | P1 | ⬜ | `create-migration` + `security-review` + `senior-backend` | **Opus** | — |
