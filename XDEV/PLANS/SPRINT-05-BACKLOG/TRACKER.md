...
**Прогрес:** 4/74 ✅ | **Розпочато:** 2026-06-21 | **Оновлено:** 2026-06-22
**▶ NEXT:** `G-LOGIN-02` — Логін мобільний: зазор між інпутом і клавіатурою (P0-блокер)
...
| `M-SHOP-04` | Магазин: модалка поповнення → vaul + собівартість | P0 | ✅ | `senior-frontend` (vaul) | **Sonnet** | `98e89c52` |
| `G-LOGIN-02` | Логін мобільний: зазор між інпутом і клавіатурою при активному полі (Google + phone; автофокус не чіпати) ← **NEXT** | P0 | ⬜ | `senior-frontend` | **Sonnet** | — |
