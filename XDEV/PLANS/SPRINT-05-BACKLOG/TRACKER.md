...
**Прогрес:** 2/74 ✅ | **Розпочато:** 2026-06-21 | **Оновлено:** 2026-06-22
**▶ NEXT:** `M-DASH-06` — Пікові години: тултіп з 2-го тапу (P0-блокер)
...
| `M-DASH-06` | Пікові години: тултіп спрацьовує з 2-го тапу ← **NEXT** | P0 | ⬜ | `diagnose` → `senior-frontend` | **Sonnet→Opus** | — |
| `M-SHOP-04` | Магазин: модалка поповнення → vaul + собівартість | P0 | ⬜ | `senior-frontend` (vaul) | **Sonnet** | — |
| `G-LOGIN-02` | Логін мобільний: зазор між інпутом і клавіатурою при активному полі (Google + phone; автофокус не чіпати) | P0 | ⬜ | `senior-frontend` | **Sonnet** | — |
...
| ID | Задача | P | Ст | Спеціаліст-скіли | Модель | Commit |
|----|--------|---|----|------------------|--------|--------|
| `G-PWA-02` | Уніфікація горизонтальних скролів (парасолька) | P1 | ⬜ | `scroll-experience` + `design-taste-frontend` | **Sonnet** | — |
| `G-PWA-01` | Скляна Safe Area (blur/backdrop при скролі) | P1 | ⬜ | `progressive-web-app` + `scroll-experience` | **Sonnet** | — |

## ФАЗА 2 — Зона Майстра: щоденні екрани

| ID | Задача | P | Ст | Спеціаліст-скіли | Модель | Commit |
|----|--------|---|----|------------------|--------|--------|
| `M-DASH-01` | Дашборд: динамічні блоки рекомендацій (top) | P1 | ⬜ | `design-taste-frontend` + `impeccable (layout)` | **Sonnet** | — |
| `M-DASH-02` | Дашборд: Quick Actions tap-анімація | P2 | ⬜ | `emilkowalski-motion` | **Sonnet** | — |
