...
**Прогрес:** 17/77 ✅ | **Розпочато:** 2026-06-21 | **Оновлено:** 2026-06-25
**▶ NEXT:** `M-DASH-07` — Дашборд: "Скасування" — overlay хто/коли (senior-frontend)
> `M-DASH-12` додано поза беклогом (ad-hoc founder): вирівнювання висоти десктоп-блоків + насичені кольори → total 76→77.
