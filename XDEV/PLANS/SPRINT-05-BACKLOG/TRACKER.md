...
**Прогрес:** 39/78 ✅ · 1 ↩️ скасовано (M-DASH-11) | **Розпочато:** 2026-06-21 | **Оновлено:** 2026-06-28
**▶ NEXT:** `M-REV-05` — Revenue: статистика по типах ціноутворення (senior-backend + design-taste-frontend · Sonnet · P1).
