...
**Прогрес:** 36/78 ✅ · 1 ↩️ скасовано (M-DASH-11) | **Розпочато:** 2026-06-21 | **Оновлено:** 2026-06-28
**▶ NEXT:** `M-REV-02` — Revenue: дослідження працездатності авто-flash-deal (diagnose + senior-backend · Opus · P1). ⚠ Нотифікаційний RPC-баг уже виправлено (commit `7b6375f8`) → M-REV-02 звужується до перевірки що авто-тригер при скасуванні реально спрацьовує.
