...
**Прогрес:** 3/74 ✅ | **Розпочато:** 2026-06-21 | **Оновлено:** 2026-06-22
**▶ NEXT:** `M-SHOP-04` — Магазин: модалка поповнення → vaul + собівартість (P0-блокер)
...
| `M-SHOP-04` | Магазин: модалка поповнення → vaul + собівартість ← **NEXT** | P0 | ⬜ | `senior-frontend` (vaul) | **Sonnet** | — |
