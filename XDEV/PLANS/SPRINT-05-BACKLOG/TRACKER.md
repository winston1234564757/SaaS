...
**Прогрес:** 18/77 ✅ · 1 ↩️ скасовано (M-DASH-11) | **Розпочато:** 2026-06-21 | **Оновлено:** 2026-06-25
**▶ NEXT:** `M-CLI-01` — Клієнти: grid-картки єдиний лейаут (impeccable layout + design-taste-frontend)
> `M-DASH-12` додано поза беклогом (ad-hoc founder): вирівнювання висоти десктоп-блоків + кольори → total 76→77. **Вирівнювання висоти лишилось. Кольори heatmap відкочено (див. M-DASH-11). Бари WeeklyChart лишились суцільно-кольоровими — відкрите питання founder.**
...
| `M-DASH-12` | Дашборд десктоп: вирівняти блоки по висоті (✅) + кольори (частково відкочено) (ad-hoc) | P1 | ✅ | `design-taste-frontend` + `impeccable (colorize)` | **Opus** | `649d9341` (висота) · `fb2a1d71`→`f477c7e9` (бари WeeklyChart суцільні, лишились) |
