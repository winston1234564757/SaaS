...
**Прогрес:** 5/74 ✅ | **Розпочато:** 2026-06-21 | **Оновлено:** 2026-06-22
...
| `G-LOGIN-02` | Логін мобільний: зазор між інпутом і клавіатурою при активному полі (Google + phone; автофокус не чіпати) | P0 | ✅ | `senior-frontend` | **Sonnet** | `e9946bc9` |
