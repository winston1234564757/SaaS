...
**Спринт:** Sprint-05 — Загальний беклог (75 задач: Зона Майстра + Клієнтська Зона + Глобальне; +1 ad-hoc M-DASH-10)
**Розпочато:** 2026-06-22
**Прогрес:** 13/75 ✅ (`G-LAND-02` · `M-SVC-01` · `M-DASH-06` · `M-SHOP-04` · `G-LOGIN-02` · `G-PWA-02` · `G-PWA-01` · `M-DASH-01` · `M-DASH-02` · `M-DASH-03` · `M-DASH-04` · `M-DASH-05` · `M-DASH-10`)
