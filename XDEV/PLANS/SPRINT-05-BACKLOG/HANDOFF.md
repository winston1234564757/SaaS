...
**Наступна задача:** Фаза 6 лендингу закрита (G-LAND-01/02/03 + G-LOGIN-01/02 ✅). Відкриті борги: `M-CLI-07` (CSV), `M-SHOP-05` (Nova Poshta API), `C-DESK-01` (десктоп — потребує founder-рев'ю підходу).
