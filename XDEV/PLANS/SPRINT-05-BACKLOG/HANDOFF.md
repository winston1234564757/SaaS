...
**Наступна задача:** Sprint-05 задачі закрито. Залишкові борги (НЕ нові задачі, а операційні кроки): (1) 🔴 застосувати NP-міграцію; (2) деплой батчем `vercel --prod`; (3) опц. ТТН-фаза M-SHOP-05. **C-DESK-01 ПОВНІСТЮ ЗАКРИТО** (усі 8 стор). **M-SHOP-05 MVP ЗАКРИТО** (`1cf2746d`).
