...
**Статус:** DONE · feel: «Pop з overshoot» · commits `6421b89c` → `92d61922` → `e0a63f90` → `ef0c1e82` (ФІНАЛ: framer whileTap прибрано, press на pointer-стейті + CSS, navigate plain onClick) · TSC 0 · Build clean
