...
**Верифікація:** TSC 0 · Build clean. ⏳ Auth-flow runtime QA (login/logout/refresh-token/impersonation/visibility-recovery через 2хв фон) НЕ прогнано — потребує e2e auth-специв або founder-перевірки.
**Commit:** pending.
