...
> 🔴 **`supabase db push` не запускати** — реєстр міграцій відстає (`20260706000000`, `20260708000000` застосовані вручну й не записані). Тільки точковий apply через Management API.
