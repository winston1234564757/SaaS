...
> Прогрес: **7/23 ✅** · Фундамент ✅ · Активна тема: Frost
> ▶ **NEXT: `DS-DASH-08`** — Топ послуги (`TopServicesWidget`, Тір 1)
...
| DS-DASH-08 | Топ послуги | `widgets/frost/TopServicesWidget.tsx` | 1 | ⬜ ▶ NEXT |
