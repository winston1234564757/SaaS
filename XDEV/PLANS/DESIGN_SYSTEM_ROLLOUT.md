...
> Розкат [DESIGN_LANGUAGE.md](file:///C:/Users/Vitossik/SaaS/XDEV/DESIGN_LANGUAGE.md) по поверхнях. Кожен пункт = окрема REDESIGN-задача за WORKFLOW (пре-код ритуал + власні очі + a11y + humanizer). **Фундамент (кіт+токени+доки) зроблено — це список споживачів.**
>
