...
| 15 | T15 | Сповіщення: каскад Push→TG + тексти + PWA deep link | ✅ | `focused-fix` + `senior-backend` | `51f0ba7` | some→every Apple cascade; /100 price fix; SW_NAVIGATE→shared; booking_cancelled deeplink+TG btn; reminder_30m TG btn |
