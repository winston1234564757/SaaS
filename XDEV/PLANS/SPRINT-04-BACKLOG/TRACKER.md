...
| 14 | T14 | Конструктор сторіс (ПК): розширення робочої зони | ✅ | `senior-frontend` | `6cc91f2` `aeb10fa` | Two-column sticky layout; ResizeObserver scale; mobile floating scroll btn; hotfix: mount-time hint (1.2s) |
