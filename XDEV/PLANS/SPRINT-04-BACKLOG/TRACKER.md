...
| 28 | T25 | dashboard/settings (ПК): повний redesign з нуля  | ✅ | `design-taste-frontend` + `impeccable` | `73676e3` `50d9fef` `9a1140a` `246ca22` | 10-col grid; ScheduleWidget 3-col bottom row; StatsPulse 6 metrics; Identity→row-4; RetentionCycle+Vacations+Segments→row-5 |
