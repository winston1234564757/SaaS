...
> Оновлено: 2026-05-16 · Статус: NotificationOrchestrator v7.0 (Фази 1–4 завершено)
...
- Новий крок `CHANNELS` між `PROFILE_PREVIEW` і `SUCCESS`
- Для TG: `generateTelegramConnectToken()` → one-time token → `https://t.me/{bot}?start={token}`
- Для Push: стандартний VAPID subscribe flow
- Прогрес-бар розширено до 4 кроків
