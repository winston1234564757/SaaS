...
| `/dashboard/marketing/new` | Створення розсилки (No-Modals) |
| `/dashboard/marketing/[id]` | Деталі розсилки по клієнтах |
...
| `/dashboard/portfolio/[id]` | Редагування кейсу портфоліо (No-Modals) |
...
| `client:open` | `clientId` | `ClientsPage` | ✅ Active |
...
| `product:edit` | `productId` | `ProductsPage` | ✅ Active |
