...
- **Логіка:**
    ...
    - **Alliance (Lifetime):** Постійна знижка на підписку. Росте ступінчасто:
        ...
        - 25 активних реф. = 25%
        - 50 активних реф. = 50%
- **Backend:** `src/lib/actions/referrals.ts` (`applyReferralRewards`) та RPC `get_master_referral_history` (міграція 20260524124500) для відображення списку залучених майстрів.
- **БД (Міграції):** 
    - `096_bounty_referral_model.sql` (Bounty & Lifetime logic)
    - `010_master_referrals.sql` (Base structure)
    - `20260524124500_get_master_referral_history.sql` (RPC для списку історії)
