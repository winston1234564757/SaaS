...
Усі файли у папці `XDEV/` є важливими для роботи. Claude зобов'язаний використовувати їх відповідно до ролей:
...
#### 10. `WHITEPAPER.md` / `INVESTMENT_MEMORANDUM.md` (Business Docs)
- **Шлях:** XDEV/WHITEPAPER.md · XDEV/INVESTMENT_MEMORANDUM.md
- **Коли читати:** Тільки при роботі з публічними/бізнес-матеріалами.
- **Що там:** Технічний whitepaper та інвестиційний меморандум — не AI-інструкції.
...
---
*Останнє оновлення: 2026-06-16 · Версія: 10.0.0*
