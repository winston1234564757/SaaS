...
|---|---|
| **4/18** ✅ | **T3** — Налаштування профілю: горизонт. скрол (ітерація 5) |
...
| 4 | T4 | Studio білінг: форма + баг сабміту | — |

### Наступна: T3 — Налаштування профілю: горизонтальний скрол
**Проблема:** Блок «Оформлення» в налаштуваннях викликає горизонтальне прокручування на мобайлі
**Скіл:** `code-reviewer`
