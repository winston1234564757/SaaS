...
|---|---|
| **3/18** ✅ | **T4** — Studio білінг: форма + баг сабміту (ітерація 4) |
...
**Проблема:** 4 підпроблеми: прибрати блок «Коли вигідніше», humanizer кнопки, телефон з профілю, submitBetaRequest() не зберігає
