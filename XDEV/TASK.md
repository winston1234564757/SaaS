...
|---|---|
| **12/30** ✅ | **T13** — Записи: баг буферу 10 хв між записами |
...
| 11 | T11 | GrowthHub мобайл: tab layout redesign | `fae6e9a` `23311f9` |
| 12 | T12 | Профіль: відпустка/вихідні overlap fix (3 таби) | `8533ce4` |
