...
|---|---|
| **13/18** ✅ | **T12** — Лояльність: два коди + двосторонній C2B бонус (ітерація 14) |
...
| 12 | T7 | Налаштування профілю десктоп | eebf5b7 |
...
|---|---|---|
| Sprint-03 (18 tasks) | 2026-06-09/... | 🔄 In progress (13/18) |
