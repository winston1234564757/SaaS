...
*   **Файли для модифікації:**
    - [MastersDirectory.tsx](file:///C:/Users/Vitos/SaaS/bookit/src/components/admin/MastersDirectory.tsx#L137-L142) (перехід на Server Action для встановлення підписаного кукі)
    - [layout.tsx (master)](file:///C:/Users/Vitos/SaaS/bookit/src/app/(master)/layout.tsx#L10-L25) (перевірка підпису кукі на сервері)
...
*   **Файли для модифікації:**
    - [DATABASE_SECURITY_RLS_MAP.md](file:///C:/Users/Vitos/SaaS/XDEV/RELEASE/MAPS/DATABASE_SECURITY_RLS_MAP.md) (актуалізувати опис)
...
*   **Файли для модифікації:**
    - [BroadcastEditor.tsx](file:///C:/Users/Vitos/SaaS/bookit/src/components/master/marketing/BroadcastEditor.tsx)
...
*   **Файли для модифікації:**
    - [globals.css](file:///C:/Users/Vitos/SaaS/bookit/src/app/globals.css)
    - [ClientDetails.tsx](file:///C:/Users/Vitos/SaaS/bookit/src/components/shared/wizard/ClientDetails.tsx)
    - [DateTimePicker.tsx](file:///C:/Users/Vitos/SaaS/bookit/src/components/shared/wizard/DateTimePicker.tsx)
...
*   **Файли для модифікації:**
    ...
    - [ProductCart.tsx](file:///C:/Users/Vitos/SaaS/bookit/src/components/shared/wizard/ProductCart.tsx) (кнопки `+` та `-`)
...
*   **Файли для модифікації:**
    - [ClientsPage.tsx](file:///C:/Users/Vitos/SaaS/bookit/src/components/master/clients/ClientsPage.tsx)
...
*   **Файли для модифікації:**
    - [BookingsPage.tsx](file:///C:/Users/Vitos/SaaS/bookit/src/components/master/bookings/BookingsPage.tsx) (або відповідний вкладений календар)
...
*   **Файли для модифікації:**
    - [SupportPage.tsx](file:///C:/Users/Vitos/SaaS/bookit/src/components/master/support/SupportPage.tsx)
...
*   **Файли для модифікації:**
    - [useBookingWizardState.ts](file:///C:/Users/Vitos/SaaS/bookit/src/components/shared/wizard/useBookingWizardState.ts)
...
*   **Файли для модифікації:**
    - [ImageCropper.tsx](file:///C:/Users/Vitos/SaaS/bookit/src/components/master/settings/components/ImageCropper.tsx)
...
*   **Файли для модифікації:**
    - [NOTIFICATION_MAP.md](file:///C:/Users/Vitos/SaaS/XDEV/RELEASE/MAPS/NOTIFICATION_MAP.md)
    - [SYSTEM_MAP.md](file:///C:/Users/Vitos/SaaS/XDEV/MAPS/SYSTEM_MAP.md)
...
*   **Файли для модифікації:**
    - [settings/tab-schedule](file:///C:/Users/Vitos/SaaS/bookit/src/components/master/settings/components/ScheduleTab.tsx) (або відповідний файл налаштувань розкладу)
...
*   **Файли для модифікації:**
    - [types.ts (onboarding)](file:///C:/Users/Vitos/SaaS/bookit/src/components/master/onboarding/steps/types.ts)
...
1. Усунення підробки сесії імперсонації в [MastersDirectory.tsx](file:///C:/Users/Vitos/SaaS/bookit/src/components/admin/MastersDirectory.tsx) та [layout.tsx (master)](file:///C:/Users/Vitos/SaaS/bookit/src/app/(master)/layout.tsx).
2. Запобігання витоку з'єднань Supabase в [useBookingWizardState.ts](file:///C:/Users/Vitos/SaaS/bookit/src/components/shared/wizard/useBookingWizardState.ts).
3. Додавання `SET search_path = public` в RPC-функції.

### Етап 2: Глобальне пристосування тем (P0-P1) — Складність: Medium
1. Додавання `--btn-primary-bg` у [globals.css](file:///C:/Users/Vitos/SaaS/bookit/src/app/globals.css) та застосування в кнопках `BookingWizard`.
2. Усунення невидимого тексту в [BroadcastEditor.tsx](file:///C:/Users/Vitos/SaaS/bookit/src/components/master/marketing/BroadcastEditor.tsx).
3. Заміна жорстких кольорів у [MorePage.tsx](file:///C:/Users/Vitos/SaaS/bookit/src/components/master/more/MorePage.tsx) та [StudioJoinPage.tsx](file:///C:/Users/Vitos/SaaS/bookit/src/components/master/studio/StudioJoinPage.tsx).

### Етап 3: Анімації та адаптивність (P1-P2) — Складність: Medium
1. Впровадження пружинного лейауту для вирівнювання висоти календаря у [BookingsPage.tsx](file:///C:/Users/Vitos/SaaS/bookit/src/components/master/bookings/BookingsPage.tsx).
2. Адаптація [ImageCropper.tsx](file:///C:/Users/Vitos/SaaS/bookit/src/components/master/settings/components/ImageCropper.tsx) під мобільні екрани.
3. Коригування тач-зон у налаштуваннях розкладу.

### Етап 4: Стандарти та сумісність (P2) — Складність: Low
1. Очищення онбордингу від емодзі у [types.ts](file:///C:/Users/Vitos/SaaS/bookit/src/components/master/onboarding/steps/types.ts).
